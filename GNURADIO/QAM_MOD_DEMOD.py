...
class QAM_MOD_DEMOD(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "QAM_MOD_DEMOD")
        ...
        self.rrc_taps_trans = rrc_taps_trans = firdes.root_raised_cosine(1.0,samp_rate,samp_rate/sps,excess_bw,11*sps)
    ...
    def set_sps(self, sps):
        ...
        self.set_rrc_taps_trans(firdes.root_raised_cosine(1.0,self.samp_rate,self.samp_rate/self.sps,self.excess_bw,11*self.sps))
    ...
    def get_rrc_taps_trans(self):
        return self.rrc_taps_trans

    def set_rrc_taps_trans(self, rrc_taps_trans):
        self.rrc_taps_trans = rrc_taps_trans
        self.fir_filter_xxx_0.set_taps(self.rrc_taps_trans)
...
def main(top_block_cls=QAM_MOD_DEMOD, options=None):
