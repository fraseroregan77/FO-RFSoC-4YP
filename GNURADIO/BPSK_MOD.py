...
# Title: BPSK Modulation Tutorial
# Author: Fraser O'Regan
...
class BPSK_MOD(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "BPSK Modulation Tutorial", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BPSK Modulation Tutorial")
        ...
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(0.1,samp_rate,samp_rate/sps,excess_bw,11*sps)
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_rrc_taps(firdes.root_raised_cosine(0.1,self.samp_rate,self.samp_rate/self.sps,self.excess_bw,11*self.sps))
