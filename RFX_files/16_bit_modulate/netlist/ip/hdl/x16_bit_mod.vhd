-- Generated from Simulink block modulate_16_bit/16_bit_mod/Algorithm/125kHz
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity x16_bit_mod_125khz is
  port (
...
end x16_bit_mod_125khz;
architecture structural of x16_bit_mod_125khz is 
...
-- Generated from Simulink block modulate_16_bit/16_bit_mod/Algorithm/500MHz
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity x16_bit_mod_500mhz is
  port (
    in1 : in std_logic_vector( 16-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end x16_bit_mod_500mhz;
architecture structural of x16_bit_mod_500mhz is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  x125khz : entity xil_defaultlib.x16_bit_mod_125khz 
  port map (
    in1 => mux_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  x500mhz : entity xil_defaultlib.x16_bit_mod_500mhz 
  port map (
    in1 => mux1_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  constant_x0 : entity xil_defaultlib.sysgen_constant_2f6aecaa34 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant1 : entity xil_defaultlib.sysgen_constant_ed5812fe11 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant2 : entity xil_defaultlib.sysgen_constant_5bffaac6e4 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant5 : entity xil_defaultlib.sysgen_constant_5bffaac6e4 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
