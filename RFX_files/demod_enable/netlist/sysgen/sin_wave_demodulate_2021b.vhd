-- Generated from Simulink block sin_wave_demodulate_2021b/DUT/Algorithm/Modulate
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity sin_wave_demodulate_2021b_modulate is
  port (
...
end sin_wave_demodulate_2021b_modulate;
architecture structural of sin_wave_demodulate_2021b_modulate is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  accumulator : entity xil_defaultlib.sysgen_addsub_aa84c8f22b 
  port map (
    clr => '0',
    a => register_q_net,
    b => step_size_net,
  ...
  addsub1 : entity xil_defaultlib.sysgen_addsub_6b2cb365c4 
  port map (
    clr => '0',
    a => accumulator_s_net,
    b => dither_dout_net,
  ...
  convert : entity xil_defaultlib.sin_wave_demodulate_2021b_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 1,
    din_bin_pt => 4,
  ...
  dither : entity xil_defaultlib.sysgen_lfsr_c1ce67ed40 
  port map (
    clr => '0',
    clk => clk_net,
    ce => ce_net,
  ...
  lut : entity xil_defaultlib.sin_wave_demodulate_2021b_xlsprom 
  generic map (
    c_address_width => 8,
    c_width => 16,
    latency => 1,
  ...
  register_x0 : entity xil_defaultlib.sin_wave_demodulate_2021b_xlregister 
  generic map (
    d_width => 14,
...
-- Generated from Simulink block sin_wave_demodulate_2021b/DUT/Algorithm
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity sin_wave_demodulate_2021b_algorithm is
  port (
...
end sin_wave_demodulate_2021b_algorithm;
architecture structural of sin_wave_demodulate_2021b_algorithm is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  modulate : entity xil_defaultlib.sin_wave_demodulate_2021b_modulate 
  port map (
    in1 => step_size_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  delay1 : entity xil_defaultlib.sin_wave_demodulate_2021b_xldelay 
  generic map (
    latency => 8,
    reg_retiming => 0,
    reset => 0,
  ...
  delay3 : entity xil_defaultlib.sin_wave_demodulate_2021b_xldelay 
  generic map (
    latency => 8,
    reg_retiming => 0,
    reset => 0,
  ...
  fir_compiler_7_2 : entity xil_defaultlib.xlfir_compiler_79156aa1a1202819079e9c964a2fa546 
  port map (
  ...
  mult : entity xil_defaultlib.sin_wave_demodulate_2021b_xlmult 
  generic map (
    a_arith => xlUnsigned,
    a_bin_pt => 0,
    a_width => 32,
    ...
    c_output_width => 48,
    c_type => 0,
    core_name0 => "sin_wave_demodulate_2021b_mult_gen_v12_0_i0",
    extra_registers => 0,
    multsign => 2,
    overflow => 1,
    p_arith => xlSigned,
  ...
  shift : entity xil_defaultlib.sysgen_shift_e6b7fa3a3a 
  port map (
    clr => '0',
    ip => mult_p_net,
    clk => clk_net,
...
-- Generated from Simulink block sin_wave_demodulate_2021b/DUT/Master FIFO
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity sin_wave_demodulate_2021b_master_fifo is
  port (
...
end sin_wave_demodulate_2021b_master_fifo;
architecture structural of sin_wave_demodulate_2021b_master_fifo is 
  signal tlast_slice_y_net : std_logic_vector( 1-1 downto 0 );
  signal tdata_slice_y_net : std_logic_vector( 32-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  concat1 : entity xil_defaultlib.sysgen_concat_e588174fb1 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  fifo : entity xil_defaultlib.sin_wave_demodulate_2021b_xlfifogen_u 
  generic map (
    core_name0 => "sin_wave_demodulate_2021b_fifo_generator_i0",
    data_count_width => 11,
    data_width => 33,
    extra_registers => 1,
    has_ae => 0,
  ...
  inverter2 : entity xil_defaultlib.sysgen_inverter_c3bee9ec3e 
  port map (
    clr => '0',
    ip(0) => fifo_af_net,
    clk => clk_net,
  ...
  inverter4 : entity xil_defaultlib.sysgen_inverter_c3bee9ec3e 
  port map (
    clr => '0',
    ip(0) => fifo_empty_net,
    clk => clk_net,
  ...
  tdata_slice : entity xil_defaultlib.sin_wave_demodulate_2021b_xlslice 
  generic map (
    new_lsb => 1,
    new_msb => 32,
    x_width => 33,
  ...
  tlast_slice : entity xil_defaultlib.sin_wave_demodulate_2021b_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 33,
...
-- Generated from Simulink block sin_wave_demodulate_2021b/DUT/Slave FIFO
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity sin_wave_demodulate_2021b_slave_fifo is
  port (
...
end sin_wave_demodulate_2021b_slave_fifo;
architecture structural of sin_wave_demodulate_2021b_slave_fifo is 
  signal fifo_dout_net : std_logic_vector( 33-1 downto 0 );
  signal fifo_empty_net : std_logic;
  signal inverter2_op_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  concat : entity xil_defaultlib.sysgen_concat_e588174fb1 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  fifo : entity xil_defaultlib.sin_wave_demodulate_2021b_xlfifogen_u 
  generic map (
    core_name0 => "sin_wave_demodulate_2021b_fifo_generator_i1",
    data_count_width => 11,
    data_width => 33,
    extra_registers => 1,
    has_ae => 0,
  ...
  inverter1 : entity xil_defaultlib.sysgen_inverter_c3bee9ec3e 
  port map (
    clr => '0',
    ip(0) => fifo_full_net,
    clk => clk_net,
  ...
  logical : entity xil_defaultlib.sysgen_logical_527409c527 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block sin_wave_demodulate_2021b/DUT
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity sin_wave_demodulate_2021b_dut is
  port (
    s_axis_tvalid : in std_logic_vector( 1-1 downto 0 );
    s_axis_tdata : in std_logic_vector( 32-1 downto 0 );
    s_axis_tlast : in std_logic_vector( 1-1 downto 0 );
...
end sin_wave_demodulate_2021b_dut;
architecture structural of sin_wave_demodulate_2021b_dut is 
  signal delay3_q_net : std_logic_vector( 1-1 downto 0 );
  signal convert_dout_net : std_logic_vector( 32-1 downto 0 );
  signal delay1_q_net : std_logic_vector( 1-1 downto 0 );
  signal inverter4_op_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  algorithm : entity xil_defaultlib.sin_wave_demodulate_2021b_algorithm 
  port map (
    tvalid_in => logical_y_net,
    tdata_in => tdata_slice_y_net,
    tlast_in => tlast_slice_y_net,
  ...
  master_fifo : entity xil_defaultlib.sin_wave_demodulate_2021b_master_fifo 
  port map (
    tvalid_out => delay3_q_net,
    tdata_out => convert_dout_net,
    tlast_out => delay1_q_net,
  ...
  slave_fifo : entity xil_defaultlib.sin_wave_demodulate_2021b_slave_fifo 
  port map (
...
-- Generated from Simulink block sin_wave_demodulate_2021b_struct
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity sin_wave_demodulate_2021b_struct is
  port (
    m_axis_tready : in std_logic_vector( 1-1 downto 0 );
    s_axis_tdata : in std_logic_vector( 32-1 downto 0 );
    s_axis_tlast : in std_logic_vector( 1-1 downto 0 );
...
end sin_wave_demodulate_2021b_struct;
architecture structural of sin_wave_demodulate_2021b_struct is 
  signal tlast_slice_y_net : std_logic_vector( 1-1 downto 0 );
  signal ce_net : std_logic;
  signal s_axis_tvalid_net : std_logic_vector( 1-1 downto 0 );
  signal inverter4_op_net : std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  dut : entity xil_defaultlib.sin_wave_demodulate_2021b_dut 
  port map (
    s_axis_tvalid => s_axis_tvalid_net,
    s_axis_tdata => s_axis_tdata_net,
    s_axis_tlast => s_axis_tlast_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity sin_wave_demodulate_2021b_default_clock_driver is
  port (
    sin_wave_demodulate_2021b_sysclk : in std_logic;
    sin_wave_demodulate_2021b_sysce : in std_logic;
    sin_wave_demodulate_2021b_sysclr : in std_logic;
    sin_wave_demodulate_2021b_clk1 : out std_logic;
    sin_wave_demodulate_2021b_ce1 : out std_logic
  );
end sin_wave_demodulate_2021b_default_clock_driver;
architecture structural of sin_wave_demodulate_2021b_default_clock_driver is 
begin
  ...
  port map (
    sysclk => sin_wave_demodulate_2021b_sysclk,
    sysce => sin_wave_demodulate_2021b_sysce,
    sysclr => sin_wave_demodulate_2021b_sysclr,
    clk => sin_wave_demodulate_2021b_clk1,
    ce => sin_wave_demodulate_2021b_ce1
  );
end structural;
-- Generated from Simulink block 
library IEEE;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity sin_wave_demodulate_2021b is
  port (
...
end sin_wave_demodulate_2021b;
architecture structural of sin_wave_demodulate_2021b is 
  attribute core_generation_info : string;
  attribute core_generation_info of structural : architecture is "sin_wave_demodulate_2021b,sysgen_core_2022_1,{,compilation=IP Catalog,block_icon_display=Default,family=zynquplusRFSOC,part=xczu43dr,speed=-2-e,package=ffve1156,synthesis_language=vhdl,hdl_library=xil_defaultlib,synthesis_strategy=Vivado Synthesis Defaults,implementation_strategy=Vivado Implementation Defaults,testbench=0,interface_doc=0,ce_clr=0,clock_period=10,system_simulink_period=4.88281e-10,waveform_viewer=0,axilite_interface=0,ip_catalog_plugin=0,hwcosim_burst_mode=0,simulation_time=4.88281e-05,addsub=2,concat=2,convert=2,delay=2,fifo=2,fir_compiler_v7_2=1,inv=4,lfsr=1,logical=1,mult=1,register=1,shift=1,slice=4,sprom=1,}";
  signal ce_1_net : std_logic;
  signal clk_1_net : std_logic;
begin
  sin_wave_demodulate_2021b_default_clock_driver : entity xil_defaultlib.sin_wave_demodulate_2021b_default_clock_driver 
  port map (
    sin_wave_demodulate_2021b_sysclk => clk,
    sin_wave_demodulate_2021b_sysce => '1',
    sin_wave_demodulate_2021b_sysclr => '0',
    sin_wave_demodulate_2021b_clk1 => clk_1_net,
    sin_wave_demodulate_2021b_ce1 => ce_1_net
  );
  sin_wave_demodulate_2021b_struct : entity xil_defaultlib.sin_wave_demodulate_2021b_struct 
  port map (
