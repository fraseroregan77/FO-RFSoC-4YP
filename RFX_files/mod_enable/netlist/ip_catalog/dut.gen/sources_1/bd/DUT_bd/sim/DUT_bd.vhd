...
architecture STRUCTURE of DUT_bd is
  ...
  signal mux_en_1 : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute X_INTERFACE_INFO of mux_en : signal is "xilinx.com:signal:data:1.0 DATA.MUX_EN DATA";
  attribute X_INTERFACE_PARAMETER of mux_en : signal is "XIL_INTERFACENAME DATA.MUX_EN, LAYERED_METADATA undef";
