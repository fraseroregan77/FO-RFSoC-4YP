...
int x16_bit_demod_CfgInitialize(x16_bit_demod *InstancePtr, x16_bit_demod_Config *ConfigPtr) {
    ...
    InstancePtr->x16_bit_demod_BaseAddress = ConfigPtr->x16_bit_demod_BaseAddress;
...
void x16_bit_demod_step_size_write(x16_bit_demod *InstancePtr, int Data) {
    ...
    x16_bit_demod_WriteReg(InstancePtr->x16_bit_demod_BaseAddress, 0, Data);
}
int x16_bit_demod_step_size_read(x16_bit_demod *InstancePtr) {
    ...
    Data = x16_bit_demod_ReadReg(InstancePtr->x16_bit_demod_BaseAddress, 0);
    return Data;
}
