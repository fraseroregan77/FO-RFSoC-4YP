-- Generated from Simulink block demodulate_16_bit/DUT/Algorithm/Demodulate
library IEEE;
...
-- Generated from Simulink block demodulate_16_bit/DUT/Algorithm
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
begin
  ...
  shift : entity xil_defaultlib.sysgen_shift_09b637fee2 
  port map (
    clr => '0',
    ip => mult_p_net,
    clk => clk_net,
...
-- Generated from Simulink block demodulate_16_bit/DUT/Master FIFO
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  concat1 : entity xil_defaultlib.sysgen_concat_6b25ecad29 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block demodulate_16_bit/DUT/Slave FIFO
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  concat : entity xil_defaultlib.sysgen_concat_6b25ecad29 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block demodulate_16_bit/DUT_struct
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
