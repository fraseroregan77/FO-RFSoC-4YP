-- Generated from Simulink block AXI_Overtone/DUT/Algorithm/NCO
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_overtone_nco is
  port (
...
end axi_overtone_nco;
architecture structural of axi_overtone_nco is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  addsub : entity xil_defaultlib.sysgen_addsub_0c41a74632 
  port map (
    clr => '0',
    a => register_q_net,
    b => mux_y_net,
  ...
  addsub1 : entity xil_defaultlib.sysgen_addsub_fc0a1d7165 
  port map (
    clr => '0',
    a => addsub_s_net,
    b => lfsr_dout_net,
  ...
  convert : entity xil_defaultlib.axi_overtone_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 1,
    din_bin_pt => 4,
  ...
  lfsr : entity xil_defaultlib.sysgen_lfsr_251fa406bb 
  port map (
    clr => '0',
    clk => clk_net,
    ce => ce_net,
  ...
  rom : entity xil_defaultlib.axi_overtone_xlsprom 
  generic map (
    c_address_width => 8,
    c_width => 16,
    latency => 1,
  ...
  register_x0 : entity xil_defaultlib.axi_overtone_xlregister 
  generic map (
    d_width => 14,
...
-- Generated from Simulink block AXI_Overtone/DUT/Algorithm
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_overtone_algorithm is
  port (
...
end axi_overtone_algorithm;
architecture structural of axi_overtone_algorithm is 
  ...
  signal rom_data_net : std_logic_vector( 16-1 downto 0 );
  signal shift_op_net : std_logic_vector( 35-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  nco : entity xil_defaultlib.axi_overtone_nco 
  port map (
    in1 => mux_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  constant_x0 : entity xil_defaultlib.sysgen_constant_5595f6db6a 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant1 : entity xil_defaultlib.sysgen_constant_c943802649 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  delay1 : entity xil_defaultlib.axi_overtone_xldelay 
  generic map (
    latency => 7,
    reg_retiming => 0,
    reset => 0,
  ...
  delay3 : entity xil_defaultlib.axi_overtone_xldelay 
  generic map (
    latency => 7,
    reg_retiming => 0,
    reset => 0,
  ...
  mux : entity xil_defaultlib.sysgen_mux_9d9813e1f4 
  port map (
    clr => '0',
  ...
  shift : entity xil_defaultlib.sysgen_shift_8ba0e1231b 
  port map (
    clr => '0',
    ip => rom_data_net,
    clk => clk_net,
...
-- Generated from Simulink block AXI_Overtone/DUT/Master FIFO
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_overtone_master_fifo is
  port (
...
end axi_overtone_master_fifo;
architecture structural of axi_overtone_master_fifo is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  concat1 : entity xil_defaultlib.sysgen_concat_18b51cf54a 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  fifo : entity xil_defaultlib.axi_overtone_xlfifogen_u 
  generic map (
    core_name0 => "axi_overtone_fifo_generator_i0",
    data_count_width => 11,
    data_width => 33,
    extra_registers => 1,
    has_ae => 0,
  ...
  inverter2 : entity xil_defaultlib.sysgen_inverter_3f0d96f4da 
  port map (
    clr => '0',
    ip(0) => fifo_af_net,
    clk => clk_net,
  ...
  inverter4 : entity xil_defaultlib.sysgen_inverter_3f0d96f4da 
  port map (
    clr => '0',
    ip(0) => fifo_empty_net,
    clk => clk_net,
  ...
  tdata_slice : entity xil_defaultlib.axi_overtone_xlslice 
  generic map (
    new_lsb => 1,
    new_msb => 32,
    x_width => 33,
  ...
  tlast_slice : entity xil_defaultlib.axi_overtone_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 33,
...
-- Generated from Simulink block AXI_Overtone/DUT/Slave FIFO
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_overtone_slave_fifo is
  port (
...
end axi_overtone_slave_fifo;
architecture structural of axi_overtone_slave_fifo is 
  signal inverter2_op_net : std_logic_vector( 1-1 downto 0 );
  signal fifo_empty_net : std_logic;
  signal fifo_full_net : std_logic;
  signal clk_net : std_logic;
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  concat : entity xil_defaultlib.sysgen_concat_9d84974aa6 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  fifo : entity xil_defaultlib.axi_overtone_xlfifogen_u 
  generic map (
    core_name0 => "axi_overtone_fifo_generator_i1",
    data_count_width => 11,
    data_width => 2,
    extra_registers => 1,
    has_ae => 0,
  ...
  inverter1 : entity xil_defaultlib.sysgen_inverter_3f0d96f4da 
  port map (
    clr => '0',
    ip(0) => fifo_full_net,
    clk => clk_net,
  ...
  logical : entity xil_defaultlib.sysgen_logical_2b933efb5c 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block AXI_Overtone/DUT
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_overtone_dut is
  port (
    s_axis_tvalid : in std_logic_vector( 1-1 downto 0 );
    s_axis_tdata : in std_logic_vector( 1-1 downto 0 );
    s_axis_tlast : in std_logic_vector( 1-1 downto 0 );
...
end axi_overtone_dut;
architecture structural of axi_overtone_dut is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  algorithm : entity xil_defaultlib.axi_overtone_algorithm 
  port map (
    tvalid_in => logical_y_net,
    tdata_in => tdata_slice_y_net,
    tlast_in => tlast_slice_y_net,
  ...
  master_fifo : entity xil_defaultlib.axi_overtone_master_fifo 
  port map (
    tvalid_out => delay3_q_net,
    tdata_out => convert_dout_net,
    tlast_out => delay1_q_net,
  ...
  slave_fifo : entity xil_defaultlib.axi_overtone_slave_fifo 
  port map (
...
-- Generated from Simulink block AXI_Overtone_struct
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_overtone_struct is
  port (
    m_axis_tready : in std_logic_vector( 1-1 downto 0 );
    s_axis_tdata : in std_logic_vector( 1-1 downto 0 );
    s_axis_tlast : in std_logic_vector( 1-1 downto 0 );
...
end axi_overtone_struct;
architecture structural of axi_overtone_struct is 
  signal m_axis_tready_net : std_logic_vector( 1-1 downto 0 );
  signal s_axis_tdata_net : std_logic_vector( 1-1 downto 0 );
  signal s_axis_tlast_net : std_logic_vector( 1-1 downto 0 );
  signal clk_net : std_logic;
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  dut : entity xil_defaultlib.axi_overtone_dut 
  port map (
    s_axis_tvalid => s_axis_tvalid_net,
    s_axis_tdata => s_axis_tdata_net,
    s_axis_tlast => s_axis_tlast_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity axi_overtone_default_clock_driver is
  port (
    axi_overtone_sysclk : in std_logic;
    axi_overtone_sysce : in std_logic;
    axi_overtone_sysclr : in std_logic;
    axi_overtone_clk1 : out std_logic;
    axi_overtone_ce1 : out std_logic
  );
end axi_overtone_default_clock_driver;
architecture structural of axi_overtone_default_clock_driver is 
begin
  ...
  port map (
    sysclk => axi_overtone_sysclk,
    sysce => axi_overtone_sysce,
    sysclr => axi_overtone_sysclr,
    clk => axi_overtone_clk1,
    ce => axi_overtone_ce1
  );
end structural;
-- Generated from Simulink block 
...
architecture structural of axi_overtone is 
  attribute core_generation_info : string;
  attribute core_generation_info of structural : architecture is "axi_overtone,sysgen_core_2024_1,{,compilation=IP Catalog,block_icon_display=Default,family=zynquplusRFSOC,part=xczu43dr,speed=-2-e,package=ffve1156,synthesis_language=vhdl,hdl_library=xil_defaultlib,synthesis_strategy=Vivado Synthesis Defaults,implementation_strategy=Vivado Implementation Defaults,testbench=0,interface_doc=0,ce_clr=0,clock_period=10,system_simulink_period=2.08333e-05,waveform_viewer=0,axilite_interface=0,ip_catalog_plugin=0,hwcosim_burst_mode=0,simulation_time=0.25,addsub=2,concat=2,constant=2,convert=2,delay=2,fifo=2,inv=4,lfsr=1,logical=1,mux=1,register=1,shift=1,slice=4,sprom=1,}";
  signal clk_1_net : std_logic;
  signal ce_1_net : std_logic;
begin
  axi_overtone_default_clock_driver : entity xil_defaultlib.axi_overtone_default_clock_driver 
  port map (
    axi_overtone_sysclk => clk,
    axi_overtone_sysce => '1',
    axi_overtone_sysclr => '0',
    axi_overtone_clk1 => clk_1_net,
    axi_overtone_ce1 => ce_1_net
  );
  axi_overtone_struct : entity xil_defaultlib.axi_overtone_struct 
  port map (
