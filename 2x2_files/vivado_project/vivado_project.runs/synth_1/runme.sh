...
HD_PWD='C:/Users/clb20123/Documents/FO-RFSoC-4YP/2x2_files/vivado_project/vivado_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log helloworld_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source helloworld_wrapper.tcl
