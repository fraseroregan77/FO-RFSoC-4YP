...
HD_PWD='C:/Users/clb20123/Documents/FO-RFSoC-4YP/2x2_files/vivado_project/vivado_project.runs/helloworld_xbar_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log helloworld_xbar_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source helloworld_xbar_2.tcl
