...
HD_PWD='C:/Users/clb20123/Documents/FO-RFSoC-4YP/2x2_files/vivado_project/vivado_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log helloworld_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source helloworld_wrapper.tcl -notrace
