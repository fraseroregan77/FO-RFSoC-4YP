...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_10 -L xil_defaultlib -L xbip_utils_v3_0_13 -L xbip_pipe_v3_0_9 -L xbip_bram18k_v3_0_9 -L mult_gen_v12_0_21 -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_17 -L zynq_ultra_ps_e_vip_v1_0_17 -L xlconstant_v1_1_9 -L axi_utils_v2_0_9 -L fir_compiler_v7_2_22 -L lib_pkg_v1_0_4 -L lib_fifo_v1_0_19 -L lib_srl_fifo_v1_0_4 -L lib_cdc_v1_0_3 -L axi_datamover_v5_1_33 -L axi_sg_v4_1_18 -L axi_dma_v7_1_32 -L proc_sys_reset_v5_0_15 -L smartconnect_v1_0 -L axi_register_slice_v2_1_31 -L generic_baseblocks_v2_1_2 -L axi_data_fifo_v2_1_30 -L axi_crossbar_v2_1_32 -L gigantic_mux -L axi_clock_converter_v2_1_30 -L axi_protocol_converter_v2_1_31 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PYNQ_Design xil_defaultlib.PYNQ_Design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim PYNQ_Design -key {Behavioral:sim_1:Functional:PYNQ_Design} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_4dc9.protoinst" -protoinst "protoinst_files/bd_5ea3.protoinst" -protoinst "protoinst_files/PYNQ_Design.protoinst" -log simulate.log
}
