...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_10 -L xil_defaultlib -L xbip_utils_v3_0_13 -L axi_utils_v2_0_9 -L fir_compiler_v7_2_22 -L xbip_pipe_v3_0_9 -L xbip_bram18k_v3_0_9 -L mult_gen_v12_0_21 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DUT_rec_0 xil_defaultlib.DUT_rec_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DUT_rec_0 -key {Behavioral:sim_1:Functional:DUT_rec_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_4dc9.protoinst" -protoinst "protoinst_files/bd_5ea3.protoinst" -protoinst "protoinst_files/bd_9ef2.protoinst" -protoinst "protoinst_files/PYNQ_Design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DUT_rec_0.wdb xsim.dir libdpi.so)
