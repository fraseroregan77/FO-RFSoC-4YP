...
begin
  ...
  port map (
    ...
    x16_bit_demod_step_size_aresetn => x16_bit_demod_aresetn,
    x16_bit_demod_step_size_aclk => clk,
    step_size => step_size,
