-- Generated from Simulink block modulate_16_bit/16_bit_mod/Algorithm/100MHz
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity x16_bit_mod_100mhz is
  port (
...
end x16_bit_mod_100mhz;
architecture structural of x16_bit_mod_100mhz is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  addsub : entity xil_defaultlib.sysgen_addsub_19deeda38b 
  port map (
    clr => '0',
    a => register_q_net,
    b => mux1_y_net,
...
-- Generated from Simulink block modulate_16_bit/16_bit_mod/Algorithm/100kHz
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity x16_bit_mod_100khz is
  port (
    in1 : in std_logic_vector( 16-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end x16_bit_mod_100khz;
architecture structural of x16_bit_mod_100khz is 
  signal ce_net : std_logic;
  signal lfsr_dout_net : std_logic_vector( 16-1 downto 0 );
  signal clk_net : std_logic;
  signal addsub_s_net : std_logic_vector( 14-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  x100mhz : entity xil_defaultlib.x16_bit_mod_100mhz 
  port map (
    in1 => mux1_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  x100khz : entity xil_defaultlib.x16_bit_mod_100khz 
  port map (
    in1 => mux_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  constant2 : entity xil_defaultlib.sysgen_constant_9fd0b1d98d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant5 : entity xil_defaultlib.sysgen_constant_9fd0b1d98d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
