-- Generated from Simulink block sin_wave_demodulate_2021b/DUT/Algorithm/Demodulate
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity dut_demodulate is
  port (
...
architecture structural of dut_demodulate is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  accumulator : entity xil_defaultlib.sysgen_addsub_512d997f3b 
  port map (
    clr => '0',
    a => register_q_net,
    b => step_size_net,
  ...
  addsub1 : entity xil_defaultlib.sysgen_addsub_455f2c187c 
  port map (
    clr => '0',
    a => accumulator_s_net,
    b => dither_dout_net,
  ...
  dither : entity xil_defaultlib.sysgen_lfsr_1251147d97 
  port map (
    clr => '0',
    clk => clk_net,
    ce => ce_net,
  ...
  lut : entity xil_defaultlib.dut_xlsprom 
  generic map (
    c_address_width => 8,
    c_width => 16,
    latency => 1,
...
begin
  ...
  out1 <= fir_compiler_7_2_s_axis_data_tready_net;
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  demodulate : entity xil_defaultlib.dut_demodulate 
  port map (
    in1 => step_size_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  fir_compiler_7_2 : entity xil_defaultlib.xlfir_compiler_921f6a16e8b88d2b52674722c92a2e68 
  port map (
  ...
  shift : entity xil_defaultlib.sysgen_shift_833f6ec992 
  port map (
    clr => '0',
    ip => mult_p_net,
    clk => clk_net,
  ...
  logical : entity xil_defaultlib.sysgen_logical_9fe0499d61 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  concat : entity xil_defaultlib.sysgen_concat_656c6a69b2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block sin_wave_demodulate_2021b/DUT_struct
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
