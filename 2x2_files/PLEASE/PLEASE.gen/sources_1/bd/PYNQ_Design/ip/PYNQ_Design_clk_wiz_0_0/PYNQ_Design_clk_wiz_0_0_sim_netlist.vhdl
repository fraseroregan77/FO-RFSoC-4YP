...
--               c:/Users/clb20123/Documents/FO-RFSoC-4YP/2x2_files/PLEASE/PLEASE.gen/sources_1/bd/PYNQ_Design/ip/PYNQ_Design_clk_wiz_0_0/PYNQ_Design_clk_wiz_0_0_sim_netlist.vhdl
...
entity PYNQ_Design_clk_wiz_0_0_clk_wiz is
  port (
...
end PYNQ_Design_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of PYNQ_Design_clk_wiz_0_0_clk_wiz is
  signal clk_in1_PYNQ_Design_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_PYNQ_Design_clk_wiz_0_0 : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_PYNQ_Design_clk_wiz_0_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      BANDWIDTH => "OPTIMIZED",
      CLKFBOUT_MULT_F => 18.750000,
      ...
      CLKIN1 => clk_in1_PYNQ_Design_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_PYNQ_Design_clk_wiz_0_0,
...
entity PYNQ_Design_clk_wiz_0_0 is
  ...
  attribute NotValidForBitStream of PYNQ_Design_clk_wiz_0_0 : entity is true;
end PYNQ_Design_clk_wiz_0_0;

architecture STRUCTURE of PYNQ_Design_clk_wiz_0_0 is
begin
inst: entity work.PYNQ_Design_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
