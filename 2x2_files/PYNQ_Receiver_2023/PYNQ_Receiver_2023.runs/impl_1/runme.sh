...
HD_PWD='C:/Users/clb20123/Documents/FO-RFSoC-4YP/2x2_files/PYNQ_Receiver_2023/PYNQ_Receiver_2023.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log work_pls_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source work_pls_wrapper.tcl -notrace
