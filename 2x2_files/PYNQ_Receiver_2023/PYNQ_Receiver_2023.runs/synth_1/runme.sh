...
HD_PWD='C:/Users/clb20123/Documents/FO-RFSoC-4YP/2x2_files/PYNQ_Receiver_2023/PYNQ_Receiver_2023.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log work_pls_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source work_pls_wrapper.tcl
