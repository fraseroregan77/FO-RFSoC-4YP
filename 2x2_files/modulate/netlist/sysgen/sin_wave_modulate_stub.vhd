...
entity sin_wave_modulate_stub is
  port (
...
end sin_wave_modulate_stub;
architecture structural of sin_wave_modulate_stub is 
begin
  sysgen_dut : entity xil_defaultlib.sin_wave_modulate 
  port map (
