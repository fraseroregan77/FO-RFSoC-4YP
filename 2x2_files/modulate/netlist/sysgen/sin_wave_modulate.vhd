...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  addsub : entity xil_defaultlib.sysgen_addsub_db8717d3ee 
  port map (
    clr => '0',
    a => register_q_net,
    b => mux1_y_net,
  ...
  generic map (
    ...
    c_width => 16,
    latency => 1,
    mem_init_file => "xpm_a622d2_vivado.mem",
    mem_size => 4096,
    mem_type => "block",
    read_reset_val => "0"
  )
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  addsub : entity xil_defaultlib.sysgen_addsub_c414c0a814 
  port map (
    clr => '0',
    a => register_q_net,
    b => mux_y_net,
...
begin
  ...
  constant3 : entity xil_defaultlib.sysgen_constant_e788f827b0 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux1 : entity xil_defaultlib.sysgen_mux_9c90c15616 
  port map (
    clr => '0',
    sel => tdata_slice_y_net,
    d0 => constant3_op_net,
