...
User_Company:VMC:DUT_receiver:1.0\
...
\
  ...
  # Create instance: DUT_receiver_0, and set properties
  set DUT_receiver_0 [ create_bd_cell -type ip -vlnv User_Company:VMC:DUT_receiver:1.0 DUT_receiver_0 ]
  ...
  connect_bd_intf_net -intf_net DUT_receiver_0_m_axis [get_bd_intf_pins DUT_receiver_0/m_axis] [get_bd_intf_pins axi_dma/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m00_axis [get_bd_intf_pins DUT_receiver_0/s_axis] [get_bd_intf_pins usp_rf_data_converter_0/m00_axis]
