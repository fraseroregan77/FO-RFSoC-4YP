...
#
# Script generated by Vivado on Fri Mar 14 12:16:19 +0000 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : DUT_rec_0.sh
...
#
# Usage        : DUT_rec_0.sh
#                DUT_rec_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DUT_rec_0.sh [-reset_run]
#                DUT_rec_0.sh [-reset_log]
#                DUT_rec_0.sh [-help]
#
...
#                script (type 'DUT_rec_0.sh -help' for more information).
#
...
design_libs=(simprims_ver xilinx_vip xpm fifo_generator_v13_2_10 xil_defaultlib xbip_utils_v3_0_13 axi_utils_v2_0_9 fir_compiler_v7_2_22 xbip_pipe_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "DUT_rec_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DUT_rec_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work fifo_generator_v13_2_10 $xmvlog_opts +incdir+"D:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.DUT_rec_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.DUT_rec_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log DUT_rec_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DUT_rec_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DUT_rec_0.sh [-help]\n\
Usage: DUT_rec_0.sh [-step]\n\
Usage: DUT_rec_0.sh [-lib_map_path]\n\
Usage: DUT_rec_0.sh [-reset_run]\n\
Usage: DUT_rec_0.sh [-reset_log]\n\
Usage: DUT_rec_0.sh [-keep_index]\n\
Usage: DUT_rec_0.sh [-noclean_files]\n\n\
