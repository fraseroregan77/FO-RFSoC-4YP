...
design_libs=(xilinx_vip xpm fifo_generator_v13_2_10 xil_defaultlib xbip_utils_v3_0_13 axi_utils_v2_0_9 fir_compiler_v7_2_22 xbip_pipe_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21)
...
compile()
{
  ...
  vlogan -work fifo_generator_v13_2_10 $vlogan_opts +v2k +incdir+"D:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.DUT_rec_0 xil_defaultlib.glbl -o DUT_rec_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./DUT_rec_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key DUT_rec_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc DUT_rec_0_simv.daidir vcs_lib c.obj)
