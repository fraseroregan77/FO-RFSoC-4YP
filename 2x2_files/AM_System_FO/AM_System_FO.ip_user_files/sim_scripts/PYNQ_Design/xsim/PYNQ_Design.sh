...
simulate()
{
  xsim PYNQ_Design -key {Behavioral:sim_1:Functional:PYNQ_Design} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_5ea3.protoinst" -protoinst "protoinst_files/bd_9ef2.protoinst" -protoinst "protoinst_files/PYNQ_Design.protoinst" -log simulate.log
}
